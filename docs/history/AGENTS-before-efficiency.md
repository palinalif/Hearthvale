# Historical instructions before the 2026-09-07 compaction

Archive only. Current root `AGENTS.md` governs work; do not load this file by default or treat historical restrictions as newer authority. Requirements were consolidated, and completed-trial context is retained here for reference.
