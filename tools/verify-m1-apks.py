...
results = []
for flavor in ["debug", "release", "compatibility"]:
    apk = Path("builds/hearthvale-m1-" + flavor + ".apk")
    ...
    metadata = "versionCode='4'" in badging.stdout and "versionName='0.1.1-m1-rework'" in badging.stdout and "name='org.hearthvale.game'" in badging.stdout
