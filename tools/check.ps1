...
Invoke-GodotBounded 'debug-bridge-action' @('--headless','--path','.','--script','res://tests/debug_bridge_action_test.gd','--max-fps','60')
...
Invoke-GodotBounded 'water-incremental-budget' @('--headless','--path','.','--script','res://tests/water_incremental_budget_test.gd','--max-fps','60')
Invoke-GodotBounded 'water-tool-responsiveness' @('--headless','--path','.','--script','res://tests/water_tool_responsiveness_test.gd','--max-fps','60')
