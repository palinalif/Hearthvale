...
foreach ($test in @('sculpt_strength_test', 'sculpt_next_layer_test', 'sculpt_occupancy_runs_test', 'sculpt_preview_job_test', 'sculpt_preview_performance_test', 'm1_terrain_ux_test')) {
