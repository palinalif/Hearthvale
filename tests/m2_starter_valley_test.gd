...
func _initialize() -> void:
	...
	if ClassDB.class_exists("VoxelBuffer"):
		...
		old.create(384,256,384)
		old.set_voxel(1,10,10,10,0)
		old.set_voxel(2,383,63,383,0)
		...
		if expanded != null:
			...
			check(expanded.get_voxel(383,63,383,0) == 2, "Last old column retained")
			check(expanded.get_voxel(20,20,20,0) == 0, "Saved excavation remains air")
			check(expanded.get_voxel(440,10,440,0) == 1, "New meadow generated outside old volume")
