...
func _initialize() -> void:
	...
	_check("New cottage" in labels and "Duplicate cottage" in labels and "Add flower box" in labels, "shell menu exposes creation duplication and detail placement")
