...
func _run() -> void:
	...
	var gable_id: String = str(scene.building_world.create_home_at("village_gable", Transform3D(gable_basis, Vector3(31.0, 8.0, 31.0)), scene.building_world.get_revision()))
	...
	var gable_path: int = int(scene.landscape_state.add_path("cobblestone", 0.875, [[29.0, 27.0], [30.0, 28.5]]))
	...
	var garden_ids: Array[int] = [
		...
		int(scene.landscape_state.add_composition("garden", "herb_garden", Vector2(35.0, 31.0), Vector2(2.25, 2.25), 1)),
	]
	var fence_ids: Array[int] = [
		int(scene.landscape_state.add_composition("fence", "rustic_fence", Vector2(17.0, 15.75), Vector2(3.0, 0.25), 0)),
		int(scene.landscape_state.add_composition("fence", "rustic_fence", Vector2(15.5, 17.0), Vector2(3.0, 0.25), 1)),
		int(scene.landscape_state.add_composition("fence", "rustic_gate", Vector2(18.5, 17.0), Vector2(1.5, 0.375), 1)),
		int(scene.landscape_state.add_composition("fence", "rustic_fence", Vector2(12.0, 37.375), Vector2(3.0, 0.25), 0)),
	]
	...
	var furniture_ids: Array[int] = [
		...
		int(scene.landscape_state.add_composition("furniture", "signpost", Vector2(28.0, 26.0), Vector2(0.625, 0.625), 1)),
		int(scene.landscape_state.add_composition("furniture", "lantern", Vector2(36.5, 25.5), Vector2(0.5, 0.5), 0)),
	]
