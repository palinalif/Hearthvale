...
func _initialize() -> void:
	...
	check(scene._roads_catalogue_open and scene._roads_catalogue_panel.visible and scene._roads_catalogue_buttons.size() == 3, "roads category opens its three-style placement catalogue")
