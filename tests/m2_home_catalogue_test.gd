...
func _initialize() -> void:
	...
	check(scene._hamlet_catalogue_open and scene._hamlet_catalogue_panel.visible and scene._hamlet_catalogue_buttons.size() == 3, "hamlet details category exposes three garden styles")
	check(scene._hamlet_catalogue_buttons[0].text.begins_with("Cottage flower garden") and scene._hamlet_catalogue_buttons[2].text.begins_with("Herb garden"), "hamlet garden choices are visually named")
	scene._return_to_build_catalogue()
