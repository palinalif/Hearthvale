...
func _read_part_orbit(delta: float) -> void:
	...
	# Pitch floor 0.62 (was 0.08): keep in sync with HAMLET_PITCH_MIN in
	...
	camera_pitch = clampf(camera_pitch + Input.get_axis("m1_orbit_up", "m1_orbit_down") * delta * 1.5, 0.62, 1.40)
