...
3. Higher-detail cottage prototype and later tree/river refinement. The player approved a cottage-only `0.0625` decorative grid for window joinery, shutters, trims, roof edges, flower boxes and flowers. Cottage structure, resize increments and attachment anchors remain at `0.125`; do not apply the finer tier to terrain or other asset families. No M2, villagers or expanded building catalogue in this pass.
